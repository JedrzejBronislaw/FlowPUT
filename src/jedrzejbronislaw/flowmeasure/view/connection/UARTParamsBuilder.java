...
public class UARTParamsBuilder extends Builder<UARTParamsController> {
	...
	public void afterBuild() {
		...
		controller.setConnectButtonAction(    actions::connectDevice);
		controller.setDisconnectButtonAction( actions::disconnectDevices);
		controller.setAutoConnectButtonAction(actions::autoconnectDevice);
	}
}
